...
import static com.example.admin.mybledemo.ui.DeviceInfoActivity.UUID_SERVER;
import static com.example.admin.mybledemo.ui.DeviceInfoActivity.UUID_SERVER_WRITE;
...
public class MyApplication extends Application {
    ...
    private void initBle() {
        Ble.options()
                ...
                .setScanPeriod(5 * 1000)//设置扫描时长
                .setMaxConnectNum(7)//最大连接数量
                .setUuidService(UUID_SERVER)//设置主服务的uuid
                .setUuidWriteCha(UUID_SERVER_WRITE)//设置可写特征的uuid
