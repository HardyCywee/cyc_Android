...
public class BleActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //CurrentTimeService currentTimeService=new CurrentTimeService(BleActivity.this);
        //currentTimeService.startServer(BleActivity.this);
        ...
        public void onLeScan(final BleRssiDevice device, int rssi, byte[] scanRecord) {
            synchronized (ble.getLocker()) {
                ...
                if (device.getBleName()!=null){
                    if(device.getBleName().contains("CWM")) {
